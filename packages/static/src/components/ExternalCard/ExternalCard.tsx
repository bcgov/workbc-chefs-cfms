        ...
        <Card>
            <Grid container direction="column" height="100%">
                <Grid item>
                    <Grid container direction="row">
                        <Grid item xs={6}>
                            <h2>Are you a Project Holder?</h2>
                            <Box paddingLeft="0.75em">
                                <p>You will need to log in to CEP Intake to access your applications.</p>
                                <p>
                                    You can log in with either a <br /> <strong>Basic BCeID</strong> or a&nbsp;
            ...
            <BCGovModal isOpen={isOpen} onRequestClose={closeModal} contentLabel="More information about BCeIDs">
                ...
                <p>
                    ...
                    user account set up, use this to log in to CEP Intake.
                </p>
                <h3>Basic BCeID</h3>
                <p>
                    With a&nbsp;
