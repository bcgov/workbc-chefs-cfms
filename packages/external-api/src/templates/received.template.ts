...
const employeeReceivedHaveEmployee = () => {
    const email = generateHTMLEmail(
        ...
        [
            `Hello,`,
            `You're receiving this email because your future user recently applied for a WorkBC Wage Subsidy.`,
        ...
        [
            ...
            `<b>Step 3:</b> Let your user know you have applied! A team member will be in touch soon.`
        ],
        [
